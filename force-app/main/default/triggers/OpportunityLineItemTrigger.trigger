trigger OpportunityLineItemTrigger on OpportunityLineItem (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
    ...
    Trg_OpportunityLineItem handler = new Trg_OpportunityLineItem(Trigger.isExecuting, Trigger.size);
    ...
    if(Trigger.isDelete && Trigger.isBefore) handler.OnBeforeDelete(Trigger.old);
