trigger AccountTrigger on Account (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
    ...
    Trg_Account handler = new Trg_Account(Trigger.isExecuting, Trigger.size);
    ...
    if(Trigger.isAfter && Trigger.isDelete) handler.OnAfterDelete(Trigger.old, Trigger.oldMap);
}